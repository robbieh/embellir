...
(defn receive-ufw
  ...
  (let [processed (reverse (take @how-many-to-keep (reverse (concat (:list ufwmap) [(line-to-map (:data rmap))]))))]
...
(comment
  ...
  (count (:list (embellir.curator/get-curio "ufw")))
